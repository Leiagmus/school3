...
$recipients[] = array(
	'email' => 'armen.simonyan.2000@gmail.com',
	'name' => 'Форма связи с школьного сайта'
);
...
// Form Messages
$message = array(
	'success'           => 'Спасибо, ваше письмо успешно отправлено.',
	'error'             => 'Упс возникла ошибка. Попробуйте отправить письмо ешё раз чуть позже.',
	'error_bot'         => 'Bot Detected! Message could not be send. Please try again.',
	'error_unexpected'  => 'Неожиданная ошибка. Попробуйте отправить письмо ешё раз чуть позже .',
	'recaptcha_invalid' => 'Captcha not Validated! Please Try Again.',
	'recaptcha_error'   => 'Каптча не верна! Попробуйте ещё раз.'
);
